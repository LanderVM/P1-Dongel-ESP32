...
#ifdef __Az__
#ifdef ETH_P1EP
#include "conf/hw_profile_p1ep_az.h"
#else
#include "conf/hw_profile_p1_eth_az.h"
#endif
#else
#define NETSWITCH
#ifdef ETH_P1EP
#define VIRTUAL_P1
#include "conf/hw_profile_p1ep.h"
#else
#include "conf/hw_profile_p1_eth.h"
#endif
#endif
#else
#ifdef NRG_DONGLE
#include "conf/hw_profile_nrgd.h"
#else
#include "conf/hw_profile_p1_pro.h"
#endif
#ifdef __Az__
#include "conf/hw_az.h"
#endif
#endif
#endif
